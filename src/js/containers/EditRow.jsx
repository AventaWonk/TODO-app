...
import {setTaskAsDone} from '../actions/index';
...
class EditRow extends React.Component {
  ...
  handleConfirmEditeClick() {
    this.props.handleConfirmEditeClick(this.props.task.id, this.state.taskInputText);
  }
    ...
    return (
      <li className="item">
        ...
        <span className="control-buttons pull-right">
          ...
          <span className="md-glyphicon" onClick={() => this.handleCancelEditeClick(this.props.task.id)}>
            <svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 0h24v24H0z" fill="none"/>
...
function mapDispatchToProps(dispatch) {
  return {
    confirmEdit: bindActionCreators(setTaskAsDone, dispatch),
    cancelEdit: bindActionCreators(setTaskAsDone, dispatch),
  };
}
